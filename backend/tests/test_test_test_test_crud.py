...
def test_create_book_empty_fields(mock_db_session):
    with pytest.raises(ValueError):
        crud.create_book(mock_db_session, "", "Test Author", "Test Category", "test.jpg", "test.pdf")
    with pytest.raises(ValueError):
        crud.create_book(mock_db_session, "Test Book", "", "Test Category", "test.jpg", "test.pdf")
    with pytest.raises(ValueError):
        crud.create_book(mock_db_session, "Test Book", "Test Author", "", "test.jpg", "test.pdf")
    with pytest.raises(ValueError):
        crud.create_book(mock_db_session, "Test Book", "Test Author", "Test Category", "", "test.pdf")
    with pytest.raises(ValueError):
        crud.create_book(mock_db_session, "Test Book", "Test Author", "Test Category", "test.jpg", "")
