...
async def test_convert_epub_to_pdf_success(mock_uuid4):
    mock_file = MagicMock()
...
async def test_upload_book_for_rag_success(mock_process_book, mock_file):
    mock_file.filename = "test.pdf"
...
@pytest.mark.asyncio
@patch('backend.main.rag.process_book_for_rag')
async def test_upload_book_for_rag_failure(mock_process_book, mock_file):
